...
function Socials({ containerStyles, iconsStyles }) {
  const socials = [
    {
      icon: <FaGithub />,
      path: "https://github.com/Saeid-Rezaei0",
      name: "گیت هاب",
    },
    {
      icon: <FaInstagram />,
      path: "https://www.instagram.com/saeid_rezai0",
      name: "اینستاگرام",
    },
    { icon: <FaTelegram />, path: "https://t.me/S_Rezaei00", name: "تلگرام" },
    {
      icon: <AiOutlineMail />,
      path: "mailto:saeid.rezaei695@gmail.com",
      name: "ایمیل",
    },
  ];
